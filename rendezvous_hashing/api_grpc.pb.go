...
type NodeClient interface {
	...
	Info(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Node_InfoClient, error)
...
func (c *nodeClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/rendezvous_hashing.Node/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeClient) Info(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Node_InfoClient, error) {
	stream, err := c.cc.NewStream(ctx, &Node_ServiceDesc.Streams[0], "/rendezvous_hashing.Node/Info", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *nodeClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/rendezvous_hashing.Node/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetResponse, error) {
	out := new(SetResponse)
	err := c.cc.Invoke(ctx, "/rendezvous_hashing.Node/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServer interface {
	...
	Info(*emptypb.Empty, Node_InfoServer) error
...
func (UnimplementedNodeServer) Health(context.Context, *emptypb.Empty) (*HealthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Health not implemented")
}
func (UnimplementedNodeServer) Info(*emptypb.Empty, Node_InfoServer) error {
...
func _Node_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rendezvous_hashing.Node/Health",
	}
...
func _Node_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rendezvous_hashing.Node/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Node_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rendezvous_hashing.Node/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Node_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rendezvous_hashing.Node",
...
func (c *clusterClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/rendezvous_hashing.Cluster/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetResponse, error) {
	out := new(SetResponse)
	err := c.cc.Invoke(ctx, "/rendezvous_hashing.Cluster/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Cluster_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rendezvous_hashing.Cluster/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cluster_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rendezvous_hashing.Cluster/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Cluster_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rendezvous_hashing.Cluster",
